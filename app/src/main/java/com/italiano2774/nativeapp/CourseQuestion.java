...
public class CourseQuestion {
    public static final int INTRO=0,MEANING=1,LISTEN=2,SPELL_HINT=3,CLOZE=4,ACTIVE=5,EXAMPLE_MEANING=6,GRAMMAR_ARTICLE=7,GRAMMAR_VERB=8;
    ...
    /** Learning-path meaning questions show one teaching pass before the choices. */
    public boolean teachBeforeTest;
}
