...
public class TodayFragment extends Fragment {
    ...
    private void openNode(LearningPathNode n){MainActivity a=(MainActivity)requireActivity();switch(n.action){
        ...
        case "grammar":a.openMicroGrammarLesson(n.payload);break;
        ...
        case "life_task":if(n.payload==null||n.payload.isEmpty())a.openLifeTaskMap();else a.openLifeTask(n.payload);break;
