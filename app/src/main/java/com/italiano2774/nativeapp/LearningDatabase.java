...
@Database(entities = {StudyEvent.class,CustomStudyItem.class,WordProgressEntity.class,DailyStatEntity.class,ErrorRecordEntity.class,SentenceProgressEntity.class,GrammarProgressEntity.class,SkillProgressEntity.class}, version = 5, exportSchema = false)
            ...
            synchronized (LearningDatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(), LearningDatabase.class,
                            "italiano2774_learning.db").setJournalMode(RoomDatabase.JournalMode.WRITE_AHEAD_LOGGING).addMigrations(MIGRATION_1_2,MIGRATION_2_3,MIGRATION_3_4,MIGRATION_4_5).build();
                }
            }
        }
        return INSTANCE;
