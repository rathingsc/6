...
for f in ['DailySummaryFragment.java','WrongWordRepairFragment.java','DatabaseHealthFragment.java','DatabaseHealthManager.java','LocalErrorLog.java']:
    req(ROOT/'app/src/main/java/com/italiano2774/nativeapp'/f)
for f in ['fragment_daily_summary.xml','fragment_wrong_word_repair.xml','fragment_database_health.xml']:
...
if 'recordSmartWordRating' not in smart_store or 'SmartMemoryScheduler.nextInterval' not in smart_store: errors.append('v3.1 smart rating persistence missing')
