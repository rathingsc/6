#!/usr/bin/env python3
"""v5.0.1 permanent Android signing/update-chain configuration gate."""
...
if ':app:assembleDebug' in cm or 'app-debug.apk' in cm:
    err('official Codemagic workflow still builds/exports debug APK; v5.0.1 must use signed release APK')
